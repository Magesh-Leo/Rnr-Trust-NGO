...
//                     currency,
//                     name: "The RNR ASSOCIATION NGO :)",
//                     description: "Donation for RNR ETHAL PAZHAGU Charity purpose.",
...
export default function Donate() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        alert(`Thank you, ${name}! Please complete your donation by scanning the UPI QR code.`);
    };
                    ...
                    <div className="donate">
                        <div className="row align-items-center">
                            <div className="col-lg-7">
                                <div className="donate-content">
                                    ...
                                    <div className="donate-text">
                                        <p>
                                            Your contribution can make a big difference. Please use the UPI QR code to donate securely.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="row mt-5">
                            <div className="col text-center">
                                ...
                                <img
                                    src="https://your-image-hosting.com/upi-qr-code.png" // Replace with your UPI QR code URL
                                    alt="UPI QR Code"
                                    style={{ maxWidth: "300px", margin: "20px auto" }}
                                />
                                <p>UPI ID: your-upi-id@bank</p> {/* Replace with your UPI ID */}
                                <p>Enter the amount: ₹{amount}</p>
                            </div>
                        </div>
                    </div>
                </div>
