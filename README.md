# The RNR-ASSOCIATES NGO - ReactJS & SpringBoot Project

This project is a web application for The RNR-ASSOCIATES NGO. It's built using **ReactJS**, **Axios**, and **Bootstrap**.
